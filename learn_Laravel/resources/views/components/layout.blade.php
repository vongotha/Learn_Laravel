    ...
    <body class="h-full">
        ...
        <nav class="bg-gray-800/50">
            ...
            <div class="flex h-16 items-center justify-between">
                ...
                <a href="/" aria-current="page" class=" {{ request()->is('/') ? 'bg-gray-950/50 text-white' : 'text-gray-300 hover:bg-white/5 hover:text-white' }} block rounded-md px-3 py-2 text-base font-medium">Home</a>
                ...
                <a href="/contact" class="block rounded-md px-3 py-2 text-base font-medium text-gray-300 hover:bg-white/5 hover:text-white">Contact</a>                    </div>
                </div>
                </div>
                <div class="hidden md:block">
